...
local config = {
  ...
  lsp = {
    ...
    -- Skip to auto-setup configuration servers
    skip_setup = { "jdtls" },
    ...
    --   require("ftplugin.java")[server].setup(opts)
    -- end,
  ...
  plugins = {
    init = {
      ...
      -- load jdtls on module
      {
        ...
        after = { "mason.nvim", "nvim-lspconfig", "mason-lspconfig.nvim" },
        ft = "java",
      },
      -- enhanced lsp uis
      {
      ...
      { "Pocco81/DAPInstall.nvim", ft = "java" },
    },
